...
create or replace function pgr_aStarTPP_radial_search_directline_sorting_3_via(IN tbl character varying,
...
begin
	...
	-- Feed the pgr_aStarTPP_radial_search_loop_nodes table with those A, B, and C nodes which are top two closest to the start point --
	For i in 1..breakwhile
		...
		End Loop;
	-- Feed the pgr_aStarTPP_radial_search_loop_nodes table with those A, B, and C nodes which are top two closest to the end point --
	For i in 1..breakwhile
		Loop
...
-- select geom from pgr_aStarTPP_radial_search_directline_sorting_3_via('ways', 29.104768000000000,41.027425000000001,29.122485000000001,41.048262999999999, 101, 102, 103)
