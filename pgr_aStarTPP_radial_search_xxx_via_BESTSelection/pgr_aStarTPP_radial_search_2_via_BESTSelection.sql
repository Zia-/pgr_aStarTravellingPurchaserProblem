...
create or replace function pgr_aStarTPP_radial_search_2_via_BESTSelection(IN tbl character varying,
...
-- select gid as id, xx as x, yy as y from pgr_aStarTPP_radial_search_2_via_BESTSelection('ways', 28.93160, 40.99315,28.97078, 41.01387, 101, 102)
